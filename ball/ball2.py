...
def new_ball():
    global x,y,r #задана глобальность координат шарика для их использования в обработке клика мыши
    canv.delete(ALL) #удаление всего нарисованного с холста (пока это один шарик)
    x = rnd(100,700) #выбор рандомных значений шарика
    y = rnd(100,500)
    r = rnd(30,50)
    canv.create_oval(x-r,y-r,x+r,y+r,fill = choice(colors), width=0) #создает сам шарик
